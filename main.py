...
async def run_bot():
    ...
    try:
        await bot.set_my_description(
            ...
            "Помогаю распределять домашние обязанности, начисляю искры за выполненные задачи, "
            "веду списки покупок и личные дела.\n\n"
            "Выполняйте дела, зарабатывайте искры ✨ и обменивайте их на награды!"
        )
        await bot.set_my_short_description(
            "Помощник по домашним делам и личным задачам. Зарабатывайте искры и обменивайте их на награды! ✨🏠"
        )
